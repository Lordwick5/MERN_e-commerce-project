    ...
    <div className="animate-fade-in">
      ...
      <div className="glass" style={{
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '1.2rem', maxWidth: '600px', margin: '0 auto 2rem' }}>
          Explore next-generation keyboards, premium audio gear, curved monitors, and precision mice to level up your work and play.
        </p>
      ...
      <h2 style={{ fontSize: '1.8rem', fontWeight: 600, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <span style={{ fontSize: '0.9rem', color: 'var(--text-secondary)', fontWeight: 400 }}>({filteredProducts.length} items)</span>
      </h2>
      ...
      {loading ? (
        ...
        <div className="glass" style={{ padding: '3rem', textAlign: 'center' }}>
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem' }}>No products match your search/filter criteria.</p>
        </div>
      ) : (
